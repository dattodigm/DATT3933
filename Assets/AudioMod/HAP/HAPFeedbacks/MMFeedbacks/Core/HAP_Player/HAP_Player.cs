...
{
	[AddComponentMenu("More Mountains/Feedbacks/Rumble Player")]
	[DisallowMultipleComponent] 
	public class HAP_Player : MMFeedbacks
	{
		#region PROPERTIES
		...
		protected override void Awake()
		{
			...
			if (AutoPlayOnEnable)
			{
				...
				playerEnabler.TargetHapPlayer = this; 
			}
		...
		private class MMF_FeedbackListCopy
		{
			...
			/// <returns></returns>
			public static List<MMF_Feedback> CopyFrom(HAP_Player source)
			{
		...
		/// </summary>
		/// <param name="source"></param>
		public virtual void CopyPlayerFrom(HAP_Player source)
		{
		...
		/// </summary>
		/// <param name="source"></param>
		public virtual void CopyFeedbackListFrom(HAP_Player source)
		{
		...
		/// </summary>
		/// <param name="source"></param>
		public virtual void AddFeedbackListFrom(HAP_Player source) 
		{
