...
namespace  XboxHaptics.Feedbacks
{
	...
	public class MMFeedbacksEvents
	{
		...
		/// </summary>
		/// <param name="source"></param>
		public virtual void TriggerOnEnable(HAP_Player source)
		{
		...
		/// </summary>
		/// <param name="source"></param>
		public virtual void TriggerOnDisable(HAP_Player source)
		{
		...
		/// </summary>
		/// <param name="source"></param>
		public virtual void TriggerOnStop(HAP_Player source)
		{
			if (!OnDisableIsNull && TriggerUnityEvents)
			{
				OnStop.Invoke();
