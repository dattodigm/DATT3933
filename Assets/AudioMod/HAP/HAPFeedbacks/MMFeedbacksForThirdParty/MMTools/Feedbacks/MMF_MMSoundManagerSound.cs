...
{    
	...
	[ExecuteAlways]
	[AddComponentMenu("")]
	[MovedFrom(false, null, "XboxHaptics.Feedbacks.MMTools")]
	...
	public class MMF_MMSoundManagerSound : MMF_Feedback
	{
		...
		/// a scriptable object (created via the Create/XboxHaptics/Audio/MMF_SoundData menu) to define settings that will override all other settings on this feedback
		[Tooltip("a scriptable object (created via the Create/XboxHaptics/Audio/MMF_SoundData menu) to define settings that will override all other settings on this feedback")]
