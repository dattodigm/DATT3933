...
namespace XboxHaptics.Tools
{
	...
	public class LightController : MonoBehaviour
	{
		...
		[MMInformation("Use this component to control the properties of one or more lights at runtime. Plays well with a FloatController. " +
		               "This component will try to auto set the TargetLight if there's a Light component on this object.", XboxHaptics.Tools.MMInformationAttribute.InformationType.Info, false)]
