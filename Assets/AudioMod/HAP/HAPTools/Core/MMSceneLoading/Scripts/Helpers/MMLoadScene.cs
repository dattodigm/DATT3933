...
{	
	...
	{
		/// the possible modes to load scenes. Either Unity's native API, or XboxHaptics' LoadingSceneManager
		...
		/// defines whether the scene will be loaded using Unity's native API or XboxHaptics' way
		[Tooltip("defines whether the scene will be loaded using Unity's native API or XboxHaptics' way")]
