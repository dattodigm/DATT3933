...
namespace XboxHaptics.Tools
{
	...
	public struct MMFadeEvent
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="XboxHaptics.MMInterface.MMFadeEvent"/> struct.
		/// </summary>
	...
	public struct MMFadeInEvent
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="XboxHaptics.MMInterface.MMFadeInEvent"/> struct.
		/// </summary>
	...
	public struct MMFadeOutEvent
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="XboxHaptics.MMInterface.MMFadeOutEvent"/> struct.
		/// </summary>
		/// <param name="duration">Duration.</param>
