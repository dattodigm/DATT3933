...
{	
	...
	public class MMMultipleObjectPooler : MMObjectPooler
	{
		...
		[MMInformation("If you set CanPoolSameObjectTwice to false, the Pooler will try to prevent the same object from being pooled twice to avoid repetition. This will only affect random pooling methods, not ordered pooling.",XboxHaptics.Tools.MMInformationAttribute.InformationType.Info,false)]
