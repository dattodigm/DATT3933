...
namespace XboxHaptics.Tools
{
	...
	public class MMPathMovement : MonoBehaviour 
	{
		...
		[Header("Movement")]
		[MMInformation("Set the <b>speed</b> at which the path will be crawled, and if the movement should be constant or eased.",XboxHaptics.Tools.MMInformationAttribute.InformationType.Info,false)]
		/// the movement speed
		...
		[Header("Settings")]
		[MMInformation("The <b>MinDistanceToGoal</b> is used to check if we've (almost) reached a point in the Path. The 2 other settings here are for debug only, don't change them.",XboxHaptics.Tools.MMInformationAttribute.InformationType.Info,false)]
