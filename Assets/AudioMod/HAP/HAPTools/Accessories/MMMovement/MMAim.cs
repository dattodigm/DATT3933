...
namespace XboxHaptics.Tools
{
	...
	public class MMAim
	{
		...
		[MMInformation("Pick a control mode : mouse (aims towards the pointer), primary movement (you'll aim towards the current input direction), or secondary movement (aims " +
		               "towards a second input axis, think twin stick shooters), and set minimum and maximum angles.", XboxHaptics.Tools.MMInformationAttribute.InformationType.Info, false)]
