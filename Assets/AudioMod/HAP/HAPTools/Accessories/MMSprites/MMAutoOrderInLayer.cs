...
namespace XboxHaptics.Tools
{
	...
	public class MMAutoOrderInLayer : MonoBehaviour 
	{
		...
		[Header("Children")]
		[MMInformation("And here you can decide to apply your new layer order to all children.",XboxHaptics.Tools.MMInformationAttribute.InformationType.Info,false)]
