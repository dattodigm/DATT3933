...
namespace XboxHaptics.Tools
{
	...
	public class MMHealthBar : MonoBehaviour 
	{
		...
		[MMInformation("Add this component to an object and it'll add a healthbar next to it to reflect its health level in real time. You can decide here whether the health bar should be drawn automatically or use a prefab.",XboxHaptics.Tools.MMInformationAttribute.InformationType.Info,false)]
		...
		[MMInformation("Select a prefab with a progress bar script on it. There is one example of such a prefab in Common/Prefabs/GUI.",XboxHaptics.Tools.MMInformationAttribute.InformationType.Info,false)]
		...
		[MMInformation("Set the size (in world units), padding, back and front colors of the healthbar.",XboxHaptics.Tools.MMInformationAttribute.InformationType.Info,false)]
		...
		[Header("Offset")]
		[MMInformation("Set the offset (in world units), relative to the object's center, to which the health bar will be displayed.",XboxHaptics.Tools.MMInformationAttribute.InformationType.Info,false)]
		...
		[Header("Display")]
		[MMInformation("Here you can define whether or not the healthbar should always be visible. If not, you can set here how long after a hit it'll remain visible.",XboxHaptics.Tools.MMInformationAttribute.InformationType.Info,false)]
